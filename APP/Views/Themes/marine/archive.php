...
<section class="hero-banner text-center text-md-start">
    <div class="container">
        <h1 class="display-5 font-weight-bold animate__animated animate__fadeInLeft">{{ $archive_title }}</h1>
        <p class="text-light mb-0">Browse latest posts related to this taxonomy keyword archive.</p>
    </div>
</section>
...
<div class="container my-5">
    <div class="row">
        ...
        <div class="{{ $mainCols }}">
            <?php if (empty($posts)) { ?>
                <div class="card p-5 text-center text-muted border-0 shadow-sm rounded-4 bg-white">
                    ...
                    <article class="card card-post overflow-hidden border-0 bg-white">
                        <div class="row g-0">
                            ...
                            <div class="col-md-<?= !empty($img) ? '8' : '12' ?> p-4 d-flex flex-column justify-content-between">
                                ...
                                <div>
                                     <a href="{{ pathto($post['slug']) }}" class="btn btn-outline-info btn-sm rounded-pill px-4 text-dark font-weight-bold">Explore &rarr;</a>
                                </div>
                            </div>
                        </div>
                    </article>
