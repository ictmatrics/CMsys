                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <?php } else { ?>
                        <?php foreach ($widget_pages as $page) { ?>
                            <li class="mb-2">
                                <a href="{{ pathto($page['slug']) }}" class="text-decoration-none small text-dark"><i class="fa-solid fa-compass me-2 text-success"></i> {{ htmlspecialchars($page['title'], ENT_QUOTES, 'UTF-8') }}</a>
                            </li>
                        <?php } ?>
                    <?php } ?>
                </ul>
