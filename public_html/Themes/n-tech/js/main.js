...
Template Name: Ntec - IT Solutions HTML5 Template
Author:  ICT Matrics
Author URI: https://framework.ictmatrics.com
Version: 1.0.0
Description: Ntec - IT Solutions HTML5 Template
...
(function ($) {
  ...
  function magicCursor() {
    ...
    $("a, button, .theme-button, .scroll-top, .acc-btn ").on(
      "mouseenter",
      function () {
  ...
  function ajaxForm() {
    ...
    const forms = document.querySelectorAll(
      ".appointment-form, .contact_form, .consulation-form, .comment-form, .subscribe-form, .newsletter-form",
    );
        ...
        document
          ...
          .addEventListener("click", (e) => {
            if (e.target.matches("li")) {
              ...
              document
                .querySelector(".current_menu_item")
                ?.classList.remove("current_menu_item");
  ...
  function sideBox() {
    ...
    $(document).on(
      "click",
      ".sidebar-close-btn, .sidebar-overlay",
      function (e) {
        e.preventDefault();
  ...
  function titleAnimation() {
    ...
    const animatedTitles = document.querySelectorAll(
      ".sec-title, .hero-content .title, .title-anim",
    );
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            const animationType =
              el.getAttribute("data-animation") || "slide-right";
  ...
  function allSlider() {
    ...
    if ($(".brands-slider-three").length > 0) {
      ...
      ["mousedown", "mouseup", "touchstart", "touchend", "click"].forEach(
        (evt) => {
  ...
  const dataItemHover = () => {
    const initHoverEffect = (container, images) => {
      ...
      container
        ...
        .on(
          "mouseleave",
          () => hoverInstance.previous && hoverInstance.previous(),
        );
    };
